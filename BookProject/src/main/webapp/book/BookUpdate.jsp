...
<h1>도서 정보 수정</h1>
	...
	<form action="update.do" method="post">
		...
		<tr><th>등록일</th><td><input type="date" name="cre_date" value="${requestScope.book.getCre_date()}" readonly></td></tr>
		<tr><th>수정일</th><td><input type="date" name="mod_date" value="${requestScope.book.getMod_date()}" readonly></td></tr>
		
		<tr><th colspan="2">
			<input type="submit" value="수정">
			<input type="reset" value="취소">
			<input type="button" value="삭제" onclick='location.href="delete.do?no=${requestScope.book.getId()}"'>
			</th></tr>
		</table>
	</form>
</body>
